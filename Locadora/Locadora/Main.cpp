...
//Verifica se o filme existe e retorna true or false
int existe_filmes_boolean(FILE* arq_filmes, int id_filmes);

//Verifica se o diretor existe e retorna true or false
int existe_diretores_boolean(FILE* arq_diretores, int id_diretores);

//Altera o filme com o ID escolhido
void altera_filme();

//Altera o diretor com o ID escolhido
void altera_diretor();

//Exclui filme com o ID selecionado
void exclui_filmes();

//Exclui diretor com o ID selecionado
void exclui_diretor();
